...
const Ebook = ({ content, formIntro }) =>  (
  <Wrapper className="[ bg-teal ]">
    <div className="[ grid grid-cols-8 col-gap-10 lg:row-gap-16 ] [ relative ]">
      ...
      <div className="[ row-start-3 md:row-start-3 lg:row-start-2 col-start-1 col-end-9 lg:col-start-2 md:col-end-5 ] [ text-white ]" dangerouslySetInnerHTML={{ __html: content }} />
      ...
      <div className="[ row-start-4 md:row-start-3 lg:row-start-2 col-start-1 col-end-9 md:col-start-5 lg:col-end-8 ] [ text-2xl text-white ]">
        ...
        <div dangerouslySetInnerHTML={{ __html: formIntro }} />
        <ConvertKitFrom />
