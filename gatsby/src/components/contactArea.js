...
const Contact = ({ backgroundColor, title, message }) => (
  <section className={`[ full-bleed contact ] [ ${backgroundColor} ] [ text-white ]`}>
    <div className="[ flow ] [ container ]">
      ...
      <form name="contact" className="[ contact__form ] [ grid grid-flow-row sm:grid-flow-col grid-cols-3 sm:grid-cols-6 md:col-gap-8 ]" method="POST" netlify-honeypot="bot-field" data-netlify="true" action="/success/">
        ...
        <textarea name="message" id="message" rows="3" className="[ row-start-6 md:row-start-4 col-start-1 col-end-4 md:col-end-7 lg:col-end-5 ]"></textarea>
